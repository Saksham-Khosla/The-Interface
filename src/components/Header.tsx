          ...
          <div style={{ display: "flex", alignItems: "stretch" }}>
            <button
              ...
              style={{
                background: "none",
                border: "none",
                borderBottom: activeView === "brief" ? "2px solid var(--accent)" : "2px solid transparent",
                position: "relative",
                top: 1,
                cursor: "pointer",
                fontFamily: "var(--font-jakarta)",
                ...
                color: activeView === "brief" ? "var(--accent)" : "var(--ink-2)",
                padding: "0 14px",
                display: "flex",
                alignItems: "center",
            ...
            <button
              ...
              style={{
                background: "none",
                border: "none",
                borderBottom: activeView === "explore" ? "2px solid var(--accent)" : "2px solid transparent",
                position: "relative",
                top: 1,
                cursor: "pointer",
                fontFamily: "var(--font-jakarta)",
                ...
                color: activeView === "explore" ? "var(--accent)" : "var(--ink-2)",
                padding: "0 14px",
                display: "flex",
                alignItems: "center",
                transition: "color 150ms ease",
