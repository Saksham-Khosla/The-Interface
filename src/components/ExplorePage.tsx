  ...
  return (
    <div>
      ...
      <div style={{ background: "var(--blush)", borderTop: "1px solid var(--rule)" }}>
        <div style={{ maxWidth: "var(--w)", margin: "0 auto", padding: "56px var(--pad)", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }}>
          <div>
            <h2 style={{ fontSize: "clamp(24px,2.4vw,34px)", fontWeight: 800, letterSpacing: "-0.03em", color: "var(--ink)", marginBottom: 14 }}>
